...
def generate_launch_description():
    ...
    declare_metrics_conf_file = DeclareLaunchArgument(
        ...
        description=(
            "Specify the name of the metrics configuration file "
    ...
    declare_result_file = DeclareLaunchArgument(
        ...
        description=(
            "Specify the name of the file where the metrics "
            "will be saved"
        ),
    )
    ...
    declare_gz_obs = DeclareLaunchArgument(
        ...
        default_value="true",
        description=(
            "Whether to fill the agents obstacles with closest "
            "Gazebo obstacle or not"
        ),
    )
